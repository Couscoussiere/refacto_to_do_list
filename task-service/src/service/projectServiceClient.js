...
export const fetchProjectStatus = async (projectId, authToken) => {
...
export const fetchProjectDates = async (projectId, authToken) => {
    const url = `${getProjectServiceUrl()}/projects/${projectId}`;
    const res = await fetch(url, {
        headers: {
            accept: "application/json",
...
export const validateDueDateAgainstProject = (taskDueDate, projectDates) => {
